!(function () {
    ...
    function cn(n, t, e) {
        ...
        var u, o;
        return ((n = isNaN(n) ? 0 : (n %= 360) < 0 ? n + 360 : n), (t = isNaN(t) ? 0 : 0 > t ? 0 : t > 1 ? 1 : t), (e = 0 > e ? 0 : e > 1 ? 1 : e), (o = 0.5 >= e ? e * (1 + t) : e + t - e * t), (u = 2 * e - o), new mn(i(n + 120), i(n), i(n - 120)));
    }
    function fn(n, t, e) {
    ...
    function pn(n, t, e) {
        var r = (n + 16) / 116,
            i = r + t / 500,
            u = r - e / 200;
        return ((i = vn(i) * na), (r = vn(r) * ta), (u = vn(u) * ea), new mn(yn(3.2404542 * i - 1.5371385 * r - 0.4985314 * u), yn(-0.969266 * i + 1.8760108 * r + 0.041556 * u), yn(0.0556434 * i - 0.2040259 * r + 1.0572252 * u)));
    }
    function gn(n, t, e) {
    ...
    function _n(n, t, e) {
        ...
        return (u = ua.get(n))
            ...
            : (null == n ||
                  ...
                  (4 === n.length ? ((o = (3840 & u) >> 4), (o = (o >> 4) | o), (a = 240 & u), (a = (a >> 4) | a), (l = 15 & u), (l = (l << 4) | l)) : 7 === n.length && ((o = (16711680 & u) >> 16), (a = (65280 & u) >> 8), (l = 255 & u))),
              t(o, a, l));
    }
    function wn(n, t, e) {
        var r,
            ...
            a = o - u,
            l = (o + u) / 2;
        return (a ? ((i = 0.5 > l ? a / (o + u) : a / (2 - o - u)), (r = n == o ? (t - e) / a + (e > t ? 6 : 0) : t == o ? (e - n) / a + 2 : (n - t) / a + 4), (r *= 60)) : ((r = NaN), (i = l > 0 && 1 > l ? 0 : r)), new ln(r, i, l));
    }
    function Sn(n, t, e) {
                ...
                (t.parse = function (t) {
                    ...
                    return (
                        'j' in r
                            ...
                            : 'W' in r || 'U' in r
                              ? ('w' in r || (r.w = 'W' in r ? 1 : 0), o.setFullYear(r.y, 0, 1), o.setFullYear(r.y, 0, 'W' in r ? ((r.w + 6) % 7) + 7 * r.W - ((o.getDay() + 5) % 7) : r.w + 7 * r.U - ((o.getDay() + 6) % 7)))
        ...
        return {
            ...
            point: function (u, o) {
                ...
                (xo(l - Fo) < Uo
                    ...
                    : i !== a && l >= Fo && (xo(e - i) < Uo && (e -= i * Uo), xo(u - a) < Uo && (u -= a * Uo), (r = Ft(e, r, u, o)), n.point(i, r), n.lineEnd(), n.lineStart(), n.point(a, r), (t = 0)),
                    n.point((e = u), (r = o)),
                    (i = a));
            },
            lineEnd: function () {
        ...
        function i(t, e, r, a, l, c, f, s, h, p, g, v, d, y) {
            ...
            if (x > 4 * u && d--) {
                var b = a + p,
                    ...
                    L = C - e,
                    q = M * z - m * L;
                ((q * q) / x > u || xo((m * z + M * L) / x - 0.5) > 0.3 || o > a * p + l * g + c * v) && (i(t, e, r, a, l, c, A, C, N, (b /= S), (_ /= S), w, d, y), y.point(A, C), i(A, C, N, b, _, w, f, s, h, p, g, v, d, y));
            }
        }
        var u = 0.5,
            o = Math.cos(30 * Yo),
                ...
                (l.tick = function () {
                    ...
                    for (r = 0; w > r; ++r)
                        ((l = x[r]),
                            ...
                            (b = p.y - h.y),
                            (v = m * m + b * b) &&
                                ((v = (i * o[r] * ((v = Math.sqrt(v)) - u[r])) / v), (m *= v), (b *= v), (p.x -= m * (y = h.weight + p.weight ? h.weight / (h.weight + p.weight) : 0.5)), (p.y -= b * y), (h.x += m * (y = 1 - y)), (h.y += b * y)));
                ...
                if (h > Uo && (g = Math.min(Math.abs(c - n) / 2, +i.apply(this, arguments))) > 0.001) {
                    ...
                    if (null != x) {
                        var I = mu(null == S ? [_, w] : [S, k], [m, M], c, T, p),
                            Y = mu([x, b], [_, w], c, T, p);
                        g === T
                            ? A.push('M', I[0], 'A', T, ',', T, ' 0 0,', v, ' ', I[1], 'A', c, ',', c, ' 0 ', (1 - p) ^ yu(I[1][0], I[1][1], Y[1][0], Y[1][1]), ',', p, ' ', Y[1], 'A', T, ',', T, ' 0 0,', v, ' ', Y[0])
                    ...
                    if (null != S) {
                        ...
                        g === R
                            ? A.push('L', V[0], 'A', R, ',', R, ' 0 0,', v, ' ', V[1], 'A', n, ',', n, ' 0 ', p ^ yu(V[1][0], V[1][1], Z[1][0], Z[1][1]), ',', 1 - p, ' ', Z[1], 'A', R, ',', R, ' 0 0,', v, ' ', Z[0])
        ...
        (ao.svg.axis = function () {
            function n(n) {
                n.each(function () {
                    ...
                    if (
                        ('bottom' === r || 'top' === r
                            ? ((n = no), (w = 'x'), (k = 'y'), (S = 'x2'), (N = 'y2'), C.attr('dy', 0 > q ? '0em' : '.71em').style('text-anchor', 'middle'), _.attr('d', 'M' + x[0] + ',' + q * u + 'V0H' + x[1] + 'V' + q * u))
                            : ((n = to), (w = 'y'), (k = 'x'), (S = 'y2'), (N = 'x2'), C.attr('dy', '.32em').style('text-anchor', 0 > q ? 'end' : 'start'), _.attr('d', 'M' + q * u + ',' + x[0] + 'H0V' + x[1] + 'H' + q * u)),
                        E.attr(N, q * i),
                        z.attr(k, q * M),
    ...
    ao.svg.brush = function () {
        ...
        return (
            ...
            (n.extent = function (t) {
                var e, r, i, u, l;
                return arguments.length
                    ? (c && ((e = t[0]), (r = t[1]), f && ((e = e[0]), (r = r[0])), (o = [e, r]), c.invert && ((e = c(e)), (r = c(r))), e > r && ((l = e), (e = r), (r = l)), (e == s[0] && r == s[1]) || (s = [e, r])),
                      f && ((i = t[0]), (u = t[1]), c && ((i = i[1]), (u = u[1])), (a = [i, u]), f.invert && ((i = f(i)), (u = f(u))), i > u && ((l = i), (i = u), (u = l)), (i == h[0] && u == h[1]) || (h = [i, u])),
                      n)
