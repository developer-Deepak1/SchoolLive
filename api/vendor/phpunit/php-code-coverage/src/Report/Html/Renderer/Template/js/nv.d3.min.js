                ...
                l.each(function (l) {
                    function m() {
                        var a = d3.mouse(this),
                            ...
                            j = !1;
                        if (
                            (k && ((d = d3.event.offsetX), (e = d3.event.offsetY), 'svg' !== d3.event.target.tagName && (i = !1), d3.event.target.className.baseVal.match('nv-legend') && (j = !0)),
                            i && ((d -= f.left), (e -= f.top)),
        ...
        (a.utils.renderWatch = function (b, c) {
            ...
            ((this.models = function (a) {
                ...
                (this.transition = function (a, b, c) {
                    if (((b = arguments.length > 1 ? [].slice.call(arguments, 1) : []), (c = b.length > 1 ? b.pop() : void 0 !== d ? d : 250), (a.__rendered = !1), e.indexOf(a) < 0 && e.push(a), 0 === c))
                        return (
                            (a.__rendered = !0),
                            (a.delay = function () {
                                return this;
                            ...
                            !i ||
                                ...
                                (t.selectAll('g').each(function (a) {
                                    (d3.select(this).select('text').attr('opacity', 1),
                                        (d(a) < d.range()[1] + 10 || d(a) > d.range()[0] - 10) && ((a > 1e-10 || -1e-10 > a) && d3.select(this).attr('opacity', 0), d3.select(this).select('text').attr('opacity', 0)));
                                }),
            ...
            function b(l) {
                return (
                    ...
                    l.each(function (l) {
                        ...
                        (bb.enter().append('rect').attr('class', 'nv-indexLine').attr('width', 3).attr('x', -2).attr('fill', 'red').attr('fill-opacity', 0.5).style('pointer-events', 'all').call(Q),
                            bb
                                .attr('transform', function (a) {
                        ...
                        (H.transition().call(f),
                            ...
                            j.dispatch.on('elementMousemove', function (b) {
                                ...
                                k.filter(function (a, b) {
                                    ...
                                    var h = g.values[e];
                                    void 0 !== h && (void 0 === d && (d = h), void 0 === i && (i = c.xScale()(c.x()(h, e))), n.push({ key: g.key, value: c.y()(h, e), color: m(g, g.seriesIndex), data: g.values[e] }));
                                });
                                ...
                                if (
                                    (j
                                        ...
                                        .forEach(function (f, g) {
                                            ...
                                            var i = f.values[h],
                                                j = b.y()(i, h);
                                            (null != j && e.highlightPoint(g, h, !0), void 0 !== i && (void 0 === d && (d = i), void 0 === m && (m = b.xScale()(b.x()(i, h))), n.push({ key: f.key, value: j, color: l(f, f.seriesIndex) })));
                                        }),
                                    n.length > 2)
                                ) {
                                    var o = b.yScale().invert(c.mouseY),
                ...
                return (
                    v.each(function (v) {
                        ...
                        (db.select('.nv-context').attr('transform', 'translate(0,' + (W + w.bottom + x.top) + ')'),
                            ...
                            G && (o._ticks(a.utils.calcTicksX(V / 100, v)).tickSize(-X, 0), db.select('.nv-context .nv-x.nv-axis').attr('transform', 'translate(0,' + h.range()[0] + ')'), db.select('.nv-context .nv-x.nv-axis').transition().call(o)),
                            F &&
                                (r
                                    .scale(h)
                                    ._ticks(X / 36)
                                ...
                                if (
                                    (o
                                        ...
                                        .forEach(function (i, j) {
                                            ...
                                            var o = m[f],
                                                p = b.y()(o, f);
                                            (null != p && g.highlightPoint(j, f, !0), void 0 !== o && (void 0 === d && (d = o), void 0 === h && (h = b.xScale()(b.x()(o, f))), k.push({ key: i.key, value: b.y()(o, f), color: s(i, i.seriesIndex) })));
                                        }),
                                    k.length > 2)
                                ) {
                    ...
                    p.each(function (b) {
                        ...
                        (M.enter().append('path'),
                            ...
                            M.on('mouseover', function (a, b) {
                                (d3.select(this).classed('hover', !0), o.elementMouseover({ label: a.name, data: a.data, index: b, pos: [d3.mouse(this.parentNode)[0], d3.mouse(this.parentNode)[1]] }));
                            }),
