...
@Component({
    ...
    standalone: true,
    imports: [CommonModule, BaseChartDirective, ButtonModule, CardModule, TableModule, TagModule, PanelModule, ProgressBarModule, AvatarModule, BadgeModule, ToastModule, RippleModule, HttpClientModule],
